...
For someone coming outside the React world "Unnecessary re-renders" might sound a thing to worry about. I've rewritten three times my first React project just to make sure this is true.
