...
GraphQL is a [reactive, functional](https://blog.danlew.net/2017/07/27/an-introduction-to-functional-reactive-programming/) approach to work with APIs. Using decoupling and composition &mdash; achieves better results than its REST predecessor.
...
![data modelling](data-model-1.png)
