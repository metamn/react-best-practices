...
(NOTE: Please check 'Resources' at the bottom of the page for quote sources)
...
In other words `useCallback` should be used when passing callbacks to children. Perhaps it's a way to remind developers every callback should be wrapped into an `useCallback`.
