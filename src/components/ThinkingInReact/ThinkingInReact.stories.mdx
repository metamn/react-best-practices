...
<Preview>
  <Story name="Side effects">
    <SideEffects param1="String" param2={true} />
  </Story>
</Preview>
...
<Preview>
  <Story name="Side effects managed with useEffect">
    <SideEffectsWithUseEffect param1="String" param2={true} />
  </Story>
</Preview>
