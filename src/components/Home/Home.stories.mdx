...
[Read more](./?path=/docs/what-is-react--page)
...
[Read more](./?path=/docs/rules-of-react--page)
...
[Read more](./?path=/docs/state--simple-state-with-use-state)
...
[Read more](./?path=/docs/memoization--page)

## GraphQL

GraphQL is a reactive and functional approach to work with APIs.

- **Topics**: Reactive programming, Functional programming, Type, Schema, Resolver, Data graph, Backend For Frontend, Headless CMS

- **Hooks**: n/a

[Read more](./?path=/docs/graphql--page)
